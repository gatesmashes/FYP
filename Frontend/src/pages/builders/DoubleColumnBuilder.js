...
const DoubleColumnResume = ({ resume: initialResume = {} }) => {
  ...
  return (
    <div className="grid grid-cols-2 h-screen font-sans">
      ...
      <div className="p-6 overflow-y-auto border-r bg-gray-50">
        <h1 className="text-2xl font-bold mb-6">Two-Column Resume Builder</h1>
      ...
      <div className="bg-gray-200 p-6 overflow-y-auto">
        <div
          id="resume-preview"
        ...
        <div className="text-center mt-6 space-x-4">
          ...
          <button
            onClick={() => {
              ...
              // Note: This requires html2pdf library. Use Print as PDF button instead.
              alert('Please use "Print as PDF" button and select "Save as PDF" from print dialog');
            }}
...
export default DoubleColumnResume;